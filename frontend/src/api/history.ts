...
export const historyApi = {
  list: async (params: HistoryListParams = {}): Promise<HistoryListResponse> => {
    ...
    if (params.min_size_bytes !== undefined)
      queryParams.append('min_size_bytes', params.min_size_bytes.toString())
    if (params.max_size_bytes !== undefined)
      queryParams.append('max_size_bytes', params.max_size_bytes.toString())
